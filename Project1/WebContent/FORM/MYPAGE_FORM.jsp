...
<div class="w3-main w3-content w3-padding"
	...
	<%
		...
		List<inputSellDto> list = searchSellDao.getInstance().showMypage(user_id);
	%>
	<h1>MY PAGE</h1>
	<!-- 책 목록 보여주기 -->
	<div class="w3-row-padding w3-padding-16 w3-center">
		...
		%>
		<div class="cont w3-quarter" id="book_click"
			style="width: 25%; height: 400px;">
			<%
				if (tmp.getBook_img().indexOf(".jpg") != -1) {
			%>
			<img src="/Project1/imageFile/<%=tmp.getBook_img()%>"
				style="width: 100%;" id="Bookimg" class="img">
			<%
				} else {
			%>
			<img src="<%=tmp.getBook_img()%>" style="width: 100%;" id="Bookimg"
				class="img">
			<%
				}
			%>
			...
			<div class="btn_cont">
				<a class="btn w3-btn w3-teal"
					href="show_detail.jsp?num=<%=tmp.getSell_num()%>"
					style="width: 100%; height: 100%;"> <br> <br> <br>
					<br> <br> <br> <i class="fas fa-check"
					style="font-size: 60px;"></i> <!-- <br><br><br>보러가기 -->
				</a>
			</div>
		</div>
